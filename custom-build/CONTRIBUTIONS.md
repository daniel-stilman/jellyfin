...
The EPUB speedup now has a separate current-master contribution branch in the existing web fork, submitted as [PR #8423](https://github.com/jellyfin/jellyfin-web/pull/8423) for [issue #8422](https://github.com/jellyfin/jellyfin-web/issues/8422). The comic web adaptation and illustrated-EPUB layout contribution remain separate work; their stable implementations are still committed and deployed on the custom release. The comic client and server parts must agree on the page API.
